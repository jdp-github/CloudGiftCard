  ...
  getOpenId: function(code) {
    ...
    wx.request({
      ...
      success: function(res) {
        ...
        var unifiedPayment = 'appid=' + appid + '&body=' + body + '&mch_id=' + mch_id + '&nonce_str=' + nonce_str + 'notify_url=' + notify_url + '&openid=' + res.data.openid + '&out_trade_no=' + that.data.out_trade_no + '&sign_type=MD5&spbill_create_ip=' + spbill_create_ip + '&total_fee=' + total_fee + '&trade_type=' + trade_type + '&key=' + key
